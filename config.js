...
module.exports = {
    ...
    GROUPN1: process.env.GROUP_NAME_1 === undefined ? 'T-REX OFFICIAL': process.env.GROUP_NAME_1,
    GROUPL1: process.env.GROUP_LINK_1 === undefined ? '': process.env.GROUP_LINK_1,
    GROUPN2: process.env.GROUP_NAME_2 === undefined ? 'T-REX OFFICIAL': process.env.GROUP_NAME_2,
