...
if (Config.WORKTYPE == 'public') {
   ...
   Trex.applyCMD({ pattern: 'attppack', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
...
`,quoted: message.data})
     ...
     Trex.applyCMD({ pattern: '01attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '02attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '03attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '04attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '05attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '06attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '07attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '08attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '09attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '10attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '11attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
     ...
     Trex.applyCMD({ pattern: '12attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Trex.applyCMD({ pattern: '13attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Trex.applyCMD({ pattern: '14attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Trex.applyCMD({ pattern: '15attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Trex.applyCMD({ pattern: '16attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Trex.applyCMD({ pattern: '17attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Trex.applyCMD({ pattern: '18attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Trex.applyCMD({ pattern: '19attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Trex.applyCMD({ pattern: '20attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Trex.applyCMD({ pattern: '21attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Trex.applyCMD({ pattern: '22attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Trex.applyCMD({ pattern: '23attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Trex.applyCMD({ pattern: '24attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '25attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Trex.applyCMD({ pattern: '26attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '27attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Trex.applyCMD({ pattern: '28attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Trex.applyCMD({ pattern: '29attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '30attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '31attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Trex.applyCMD({ pattern: '32attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '33attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '34attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '35attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '36attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '37attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '38attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Trex.applyCMD({ pattern: '39attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Trex.applyCMD({ pattern: '40attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
