...
Asena.addCommand({pattern: 'admin', desc: Lang.ADMINDESC, fromMe: true, dontAddCommandList: false}, (async (message, match) => {    
...
Asena.addCommand({pattern: 'clear', fromMe: true, desc: Lang.END, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({pattern: 'subject ?(.*)', onlyGroup: true, fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
