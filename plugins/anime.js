...
if (Config.WORKTYPE == 'private') {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '*❰🐼🧭Sketchy🧭🐼❱*'})
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '*❰🐼🧭Sketchy🧭🐼❱*' ,quoted: message.data})
