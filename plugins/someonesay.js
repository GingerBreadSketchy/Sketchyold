...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'animesay ?(.*)', desc: Lang.ANIME_DESC }, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'changesay ?(.*)', desc: Lang.CHANGE_DESC }, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'trumpsay ?(.*)', desc: Lang.TRUMP_DESC }, (async (message, match) => {
