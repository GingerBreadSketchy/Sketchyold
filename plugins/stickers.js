        ...
        await webp2mp4File(savedFilename).then(async (rest) => {
            await Axios({ method: "GET", url: rest.result, responseType: "stream"}).then(({ data }) => {
                ...
                saving.on("finish", async () => {
                    await message.client.sendMessage(msgid, fs.readFileSync('/root/8gh32jk565/vstic.mp4'), MessageType.video, { mimetype: Mimetype.mp4, caption: 'Copyright © 2021 | Queen Amdi', quoted: message.data })
