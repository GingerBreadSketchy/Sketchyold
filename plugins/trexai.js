...
QueenSew.applyCMD({on: 'text', fromMe: wk, dontAdCommandList: true, delownsewcmd: false}, (async (message, match) => {
...
QueenSew.applyCMD({ pattern: 'fullrex ?(.*)', desc: fulleva_dsc, fromMe: true, usage: '.fullsew on / off' }, (async (message, match) => {
