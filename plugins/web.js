...
Asena.addCommand({pattern: 'ping', deleteCommand: false, desc: Lang.PING_DESC}, (async (message, match) => {
...
Asena.addCommand({pattern: 'short ?(.*)', desc: Lang.URL}, (async (message, match) => {
